# Contributing to electrometer-lora-iot

Thanks for improving electrometer-lora-iot. Open an issue first for large changes so we can
agree on scope.
...
3. Install the toolchain this repo already uses (the language already used in this repository) and any dependencies
